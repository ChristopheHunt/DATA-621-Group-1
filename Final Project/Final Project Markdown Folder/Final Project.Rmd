...
iowaCounties <- fread("https://raw.githubusercontent.com/ChristopheHunt/DATA-621-Group-1/master/Final%20Project/Final%20Project%20Markdown%20Folder/iowaCounties.csv", verbose = F)
...
ggplot(iowaCounties %>% filter(County == "POLK"), aes(x = County, y = `Volume Sold (Gallons)`, fill = City)) + 
      ...
      xlab("County") + 
      ylab("Volume Sold by Gallons\n") +
      ggtitle("Gallons Sold by County and City for Whiskey Categories")
```
