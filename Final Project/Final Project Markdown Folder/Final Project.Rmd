...
pandoc.table(x, caption = "Influential points in Bottles Sold Model")
...
pandoc.table(influence, caption = "Influential points in Log of Bottles Sold Model")
#2. Cooks distance plot
cook <- plot(fit2,4)
```
...
The forward selection method removed the variable Pack from our final model. Removed Pack 
...
The table of our detailed model for log Profit Dollars is located in the Appendix. 
...
dfLiquorSales <- dfLiquorSales %>% select(-Store.Number, -Category.Name, -Store.Name, -X)
describedData <- describe(dfLiquorSales)
latex(describedData, file = '')
```

```{r, results='asis', echo=FALSE, eval=FALSE}
Store.Names <- as.character(abbreviate(dfLiquorSales$Store.Name))
