...
\subsection{\texorpdfstring{\protect\includegraphics{Final_Project_files/figure-latex/unnamed-chunk-9-1.pdf}}{}}\label{section}
...
\begin{itemize}\raggedright
  ...
  \item Other packages: data.table~1.10.0, dplyr~0.5.0,
    ...
    pacman~0.4.1, pander~0.6.0, purrr~0.2.2, RColorBrewer~1.1-2,
    readr~1.0.0, stargazer~5.2, survival~2.40-1, tibble~1.2,
  ...
  \item Loaded via a namespace (and not attached): acepack~1.4.1,
    ...
    labeling~0.3, latticeExtra~0.6-28, lazyeval~0.2.0,
    Matrix~1.2-7.1, munsell~0.4.3, nnet~7.3-12, openssl~0.9.5,
    plyr~1.8.4, R6~2.2.0, Rcpp~0.12.8, reshape2~1.4.2,
