...
\caption{Summary Statistics of Bottles Sold}\tabularnewline
\toprule
...
The lambda value of the BoxCox transformation of the Bottles Sold is 1.
...
\begin{longtable}[]{@{}cccccccc@{}}
\caption{Summary Statistics of Bottles Sold after LOG transformation
...
Below is the values in question we chose to exclude.
...
\textbf{229}\strut
\end{minipage} & \begin{minipage}[t]{0.32\columnwidth}\centering\strut
STRAIGHT BOURBON WHISKIES\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\centering\strut
Hy-Vee \#3 / BDI / Des Moines\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\centering\strut
9.833\strut
