...
\caption{influencial points}\tabularnewline
\toprule
...
Below are the diagnostic plots for our Model 1, without influencial
...
We measure this value as pricing strategies are necessary in attempting
to maximize efficient inventory control. Using the forward selection
method we find that the variables \texttt{Pack} and
