...
\begin{frontmatter}
  ...
  applied to predict the volume of liquor sold and the profit dollars
  ...
  of November of 2015. Before outputting the models, the influential
  points were all removed. When the number of bottles sold was predicted,
  two models were rendered. In the first and third models, the only
  variable that showed significance was Canadian Whiskies. This variable
  increases the bottles sold and the profit respectively by factors of
  30.67 and 27.88.
