...
distribution is futher highlighted in the diagnostic plots.
...
## + State.Bottle.Cost      1    358.73 570.47 160.74
## + State.Bottle.Retail    1    358.43 570.77 160.94
## + Volume.Sold..Gallons.  1    299.74 629.45 197.74
## + Sale..Dollars.         1    252.49 676.70 224.95
## + Category.Name          7    205.28 723.92 262.31
## + Pack                   1     21.38 907.82 335.43
## <none>                               929.20 342.18
## + Bottle.Volume..ml.     1      3.94 925.26 342.58
## 
## Step:  AIC=160.74
## log(Bottles.Sold) ~ State.Bottle.Cost
## 
##                         Df Sum of Sq    RSS     AIC
## + Category.Name          7   151.775 418.69  58.436
## + Pack                   1    43.311 527.15 133.052
## + State.Bottle.Retail    1    29.887 540.58 142.507
## + Volume.Sold..Gallons.  1    27.025 543.44 144.492
## + Sale..Dollars.         1    14.693 555.77 152.929
## <none>                               570.47 160.741
## + Bottle.Volume..ml.     1     0.102 570.36 162.673
## 
## Step:  AIC=58.44
## log(Bottles.Sold) ~ State.Bottle.Cost + Category.Name
## 
##                         Df Sum of Sq    RSS    AIC
## + State.Bottle.Retail    1   18.1372 400.55 43.785
## + Volume.Sold..Gallons.  1   12.4052 406.28 49.127
## + Sale..Dollars.         1   11.3771 407.31 50.077
## + Pack                   1   11.1650 407.53 50.273
## <none>                               418.69 58.436
## + Bottle.Volume..ml.     1    0.1651 418.53 60.287
## 
## Step:  AIC=43.78
## log(Bottles.Sold) ~ State.Bottle.Cost + Category.Name + State.Bottle.Retail
## 
##                         Df Sum of Sq    RSS    AIC
## + Pack                   1   11.3391 389.21 34.987
## + Volume.Sold..Gallons.  1   10.3570 390.20 35.935
## + Sale..Dollars.         1    8.8037 391.75 37.428
## <none>                               400.55 43.785
## + Bottle.Volume..ml.     1    0.1319 400.42 45.661
## 
## Step:  AIC=34.99
## log(Bottles.Sold) ~ State.Bottle.Cost + Category.Name + State.Bottle.Retail + 
##     Pack
## 
##                         Df Sum of Sq    RSS    AIC
## + Volume.Sold..Gallons.  1   11.2331 377.98 25.976
## + Sale..Dollars.         1    9.2554 379.96 27.938
## + Bottle.Volume..ml.     1    8.3716 380.84 28.811
## <none>                               389.21 34.987
## 
## Step:  AIC=25.98
## log(Bottles.Sold) ~ State.Bottle.Cost + Category.Name + State.Bottle.Retail + 
##     Pack + Volume.Sold..Gallons.
## 
##                      Df Sum of Sq    RSS    AIC
## + Bottle.Volume..ml.  1    7.0976 370.88 20.848
## <none>                            377.98 25.976
## + Sale..Dollars.      1    0.7370 377.24 27.242
## 
## Step:  AIC=20.85
## log(Bottles.Sold) ~ State.Bottle.Cost + Category.Name + State.Bottle.Retail + 
##     Pack + Volume.Sold..Gallons. + Bottle.Volume..ml.
## 
##                  Df Sum of Sq    RSS    AIC
## <none>                        370.88 20.848
## + Sale..Dollars.  1   0.65523 370.23 22.183
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Removal of influence points based on two methods}
\CommentTok{#1. influence points}
\KeywordTok{influencePlot}\NormalTok{(fit2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#2. Cooks distance plot}
\KeywordTok{plot}\NormalTok{(fit2,}\DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#State.Bottle.Cost=One unit of increase in State.Bottle.Cost will increase }
\CommentTok{#the log of bottles sold by 1.06 units}

\CommentTok{#Category.Name}
\CommentTok{# CANADIAN WHISKIES, IRISH, SCOTCH are highly significant. }
\CommentTok{# In comparison to BLENDED WHISKIES, Canadian Whiskies will increase the log of bottles sold by 0.75}
\CommentTok{# In comparison to BLENDED WHISKIES, IRISH Whiskies will decrease the log of  bottles sold by 0.76}
\CommentTok{# In comparison to BLENDED WHISKIES, SCOTCH Whiskies will decrease the log of bottles sold by 0.60}
\CommentTok{# In comparison to BLENDED WHISKIES, SINGLE BARREL BOURBON Whiskies will decrease the log of  bottles sold by 0.68}
\CommentTok{# In comparison to BLENDED WHISKIES, STRAIGHT BOURBON Whiskies will decrease the log of  bottles sold by 0.11}
\CommentTok{# In comparison to BLENDED WHISKIES, STRAIGHT RYE Whiskies will decrease thelog of  bottles sold by 0.54}
\CommentTok{# In comparison to BLENDED WHISKIES, TENNESSEE WHISKIES  will decrease the log of bottles sold by 0.30}

\CommentTok{#State.Bottle.Retail=One unit of increase in State.Bottle.Retail will decrease the log of bottles sold by 0.70 units}
\CommentTok{#Pack=One unit of increase in Pack will increase the log of bottles sold by 0.06  units }
\CommentTok{#Volume.Sold..Gallons.=One unit of increase in Volume.Sold..Gallons. will increase the log of bottles sold by 0.013 units}
\CommentTok{#Bottle.Volume..ml=One unit of increase in Bottle.Volume..ml will increase the log of bottles sold by 0.0005 units}





\KeywordTok{plot}\NormalTok{(fit2$model$}\StringTok{`}\DataTypeTok{log(Bottles.Sold)}\StringTok{`}\NormalTok{,fit2$fitted.values)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Final_Project_files/figure-latex/unnamed-chunk-14-7.pdf}
...
\begin{itemize}\raggedright
  ...
  \item Loaded via a namespace (and not attached): acepack~1.4.1,
    ...
    lazyeval~0.2.0, lme4~1.1-12, Matrix~1.2-7.1,
    MatrixModels~0.4-1, mgcv~1.8-16, minqa~1.2.4, munsell~0.4.3,
    nlme~3.1-128, nloptr~1.0.4, nnet~7.3-12, openssl~0.9.5,
    parallel~3.3.2, pbkrtest~0.4-6, plyr~1.8.4, quadprog~1.5-5,
    quantreg~5.29, R6~2.2.0, Rcpp~0.12.8, reshape2~1.4.2,
