...
\begin{spacing}{0.7}
\begin{center}\textbf{ dfLiquorSales \%$>$\% select(-Store.Number, -Category.Name, -Store.Name, -X) \\ 11 Variables~~~~~ 376 ~Observations}\end{center}
...
\begin{spacing}{0.7}
\noindent\textbf{dfLiquorSales\$Store.Name}\setlength{\unitlength}{0.001in}\hfill\begin{picture}(1.5,.1)(1500,0)\linethickness{0.6pt}
\put(0,0){\line(0,1){44}}
...
\end{spacing}\begin{spacing}{0.7}
\noindent\textbf{dfLiquorSales\$Store.Number}\setlength{\unitlength}{0.001in}\hfill\begin{picture}(1.5,.1)(1500,0)\linethickness{0.6pt}
\put(0,0){\line(0,1){100}}
...
\end{spacing}\begin{spacing}{0.7}
\noindent\textbf{dfLiquorSales\$Category.Name}\setlength{\unitlength}{0.001in}\hfill\begin{picture}(1.5,.1)(1500,0)\linethickness{0.6pt}
\put(0,0){\line(0,1){86}}
