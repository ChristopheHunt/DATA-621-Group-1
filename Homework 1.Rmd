...
We noted that several variables were missing a nontrivial amount of observations and these variables; Strikeouts by batters, Stolen Bases, Caught stealing, Batters hit by pitch (get a free base), Strikeouts by pitcher, Double plays will require us to address the missing values for further analysis. 
