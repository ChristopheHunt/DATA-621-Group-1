...
The following table provides the detailed descriptive statistics regarding our variable of interest - Number of Wins and our possible explanatory variables. 
...
```{r, results='asis', echo = FALSE, fig.cap= "Correlation Plot of Training Data Set" }
cor_matrix <- cor(df %>% select(-`Identification Variable (do not use)`), use="complete.obs",  method = c("pearson"))
corrplot(cor_matrix, method="square",  order="hclust", addrect=2, tl.col = "black", tl.cex=.5, na.label = "NA")
```
