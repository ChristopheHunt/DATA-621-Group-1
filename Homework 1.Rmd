...
imputed_data <- read.csv("https://github.com/ChristopheHunt/DATA-621-Group-1/blob/master/imputed-moneyball-training-data.csv")
```
...
```{r, include = FALSE}
imputed_df <- imputed_df %>% select(-`Batters hit by pitch (get a free base)`, -`Caught stealing`)
```
