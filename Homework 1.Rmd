...
lmfit <- lm(data = imputed_df, 
           `Number of wins`^(1/3) ~ `Base Hits by batters (1B,2B,3B,HR)` +  `Walks by batters` + sqrt(`Strikeouts by batters`))

stargazer(lmfit, header = FALSE,  
          covariate.labels = c("Base Hits by batters (1B,2B,3B,HR)", "Walks by batters", "$\\sqrt{\\textnormal{Strikeouts~by~batters}}$"),
