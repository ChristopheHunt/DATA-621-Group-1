...
as its discrimination threshold is varied. The curve is created by plotting True Positive Rate against Falst Positive Rate at various threshold settings.
...
dfROC <- ROC(scores,'class', 'scored.class', 1, 0, x)
