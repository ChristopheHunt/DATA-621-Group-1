...
Using the `leaps` package and the `regsubsets` function we are able to subset our independent variables by looking at the best model for each predictor. Our final model using this method is `8` which we will further implement into our model. 
...
```{r, model from subset, eval=TRUE, cache=TRUE, results = 'asis'}
