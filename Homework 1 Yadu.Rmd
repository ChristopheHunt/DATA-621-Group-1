...
Histograms of all of the variables were plotted so that the distribution of the data could be visualized. The reason for the strong skew in the number of walks allowed was because of the excessive number of outliers. Thus, the rows containing all of these outliers were removed from the original dataset. After all of these rows were removed, the skew in the number of walks allowed was significantly reduced to below 1. 
