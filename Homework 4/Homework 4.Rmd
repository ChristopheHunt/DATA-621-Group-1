...
```{r subset model metrics, echo=FALSE, results='asis', eval=FALSE,  cache=TRUE}
...
dfPred <- data.frame(cbind(df[,c()],predProb,predResp))

dfFitModel <- ModelMetrics(dfPred,"predResp","target",1,0,"Model Metrics for Subset Selection", fit$aic)

kable(dfFitModel, align = c("l","c"))
```
